...
from torch.utils.data import DataLoader, ConcatDataset, Subnet
...
def main(config):
    ...
    valid_loader = DataLoader(valid_set, batch_size=config['batch_size'], shuffle=True, num_workers=8, pin_memory=True)
